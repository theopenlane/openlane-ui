    ...
    <PlateElement ref={ref} className={cn('inline-block', className)} contentEditable={false} {...props}>
      <Popover>
        <PopoverTrigger asChild>
          <span className={cn('w-fit cursor-pointer rounded-sm bg-oxford-blue-100 px-1 text-oxford-blue-500 dark:bg-oxford-blue-800 dark:text-oxford-blue-400')} contentEditable={false}>
            {element.date ? (
              (() => {
