...
import { focusEditor, useEditorPlugin, useEditorRef, useEditorSelector, useElement, useRemoveNodeButton, withHOC } from '@udecode/plate-common/react'
import {
  TablePlugin,
  TableProvider,
  deleteColumn,
...
import { type LucideProps, Combine, Minus, Plus, RectangleHorizontal, RectangleVertical, Trash2Icon, Ungroup } from 'lucide-react'
  ...
  return (
    <Popover open={open} modal={false}>
      ...
      {(canMerge || canUnmerge || collapsed) && (
        <PopoverContent ref={ref} className={cn(popoverVariants(), 'flex w-[220px] flex-col p-1')} onOpenAutoFocus={(e) => e.preventDefault()} {...props}>
          {unmergeButton}
          {mergeContent}
          {bordersContent}
        </PopoverContent>
...
const BorderAll = (props: LucideProps) => (
  <svg fill="currentColor" focusable="false" height="48" role="img" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg" {...props}>
