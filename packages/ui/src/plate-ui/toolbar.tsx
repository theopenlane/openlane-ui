...
export const ToolbarSeparator = withCn(ToolbarPrimitive.Separator, 'mx-2 my-1 w-px shrink-0 bg-oxford-blue-200 dark:bg-oxford-blue-800')
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        outline: 'border border-border bg-transparent hover:bg-oxford-blue-100 hover:text-oxford-blue-900 dark:hover:bg-oxford-blue-800 dark:hover:text-oxford-blue-50',
      },
    },
  },
)
        ...
        >
          {isDropdown ? (
            <>
              ...
              <div>
                <ChevronDown className="size-3.5 text-oxford-blue-500 dark:text-oxford-blue-400" data-icon />
              </div>
            </>
          ) : (
            children
