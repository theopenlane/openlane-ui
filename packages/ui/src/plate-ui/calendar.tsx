  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_middle: 'aria-selected:bg-oxford-blue-100 aria-selected:text-oxford-blue-900 dark:aria-selected:bg-oxford-blue-800 dark:aria-selected:text-oxford-blue-50',
        day_selected:
        ...
        head_cell: 'text-oxford-blue-500 rounded-md w-9 font-normal text-[0.8rem] dark:text-oxford-blue-400',
        head_row: 'flex',
        month: 'space-y-4',
