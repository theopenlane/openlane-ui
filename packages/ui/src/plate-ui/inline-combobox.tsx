...
const InlineComboboxContent: typeof ComboboxPopover = ({
  ...
  return (
    <Portal>
      <ComboboxPopover
        className={cn(
          'z-[500] max-h-[288px] w-[300px] overflow-y-auto rounded-md bg-white shadow-md dark:bg-oxford-blue-950',
          className
        )}
        {...props}
      />
...
const InlineComboboxGroupLabel = withCn(
  ComboboxGroupLabel,
  'mb-2 mt-1.5 px-3 text-xs font-medium text-oxford-blue-500 dark:text-oxford-blue-400'
);
