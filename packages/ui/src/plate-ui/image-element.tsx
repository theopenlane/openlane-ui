        ...
        <PlateElement ref={ref} className={cn('py-2.5', className)} {...props}>
          <figure className="group relative m-0" contentEditable={false}>
            ...
            >
              ...
              <Image
                className={cn('block w-full max-w-full cursor-pointer object-cover px-0', 'rounded-sm', focused && selected && 'ring-2 ring-oxford-blue-950 ring-offset-2 dark:ring-oxford-blue-300')}
                alt=""
                {...nodeProps}
              />
              <ResizeHandle
