...
>(({ children, state, ...props }, componentRef) => {
  ...
  return (
    <div ref={clickOutsideRef}>
      <Toolbar
        ref={ref}
        className={cn('absolute z-50 whitespace-nowrap rounded-md border border-border bg-white p-1 opacity-100 shadow-md print:hidden dark:bg-oxford-blue-950', 'max-w-[80vw]')}
        {...rootProps}
        {...props}
      >
        {children}
