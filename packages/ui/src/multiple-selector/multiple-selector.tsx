...
// import { Command, CommandGroup, CommandItem, CommandList } from '@/plate-ui/command'
...
const CommandEmpty = forwardRef<HTMLDivElement, React.ComponentProps<typeof CommandPrimitive.Empty>>(({ className, ...props }, forwardedRef) => {
  ...
  return (
    <div
      ref={forwardedRef}
      className={cn('py-6 text-center text-sm rounded-md border border-border-light dark:border-border-dark bg-input-background shadow-md', className)}
      cmdk-empty=""
      role="presentation"
      {...props}
    />
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'min-h-10 rounded-md border border-border-light dark:border-border-dark bg-input-background text-base md:text-sm px-3 py-2',
            {
