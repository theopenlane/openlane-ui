            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    'data-[disabled]:bg-muted-foreground data-[disabled]:text-muted-foreground data-[disabled]:-foreground',
                    'data-[fixed]:bg-muted-foreground data-[fixed]:text-muted-foreground data-[fixed]:-foreground',
                    badgeClassName,
                  )}
