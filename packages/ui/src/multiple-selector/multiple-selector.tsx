 ...
 **/
const CommandEmpty = ({ className, ref, ...props }: React.ComponentProps<typeof CommandPrimitive.Empty> & { ref?: React.Ref<HTMLDivElement> }) => {
  const render = useCommandState((state) => state.filtered.count === 0)

  if (!render) return null

  return <div ref={ref} className={cn('py-6 text-center text-sm rounded-md border bg-input shadow-md', className)} cmdk-empty="" role="presentation" {...props} />
}
