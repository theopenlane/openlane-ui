...
export const dropdownMenuStyles = tv({
  slots: {
    ...
    menuItem:
      'cursor-pointer relative flex select-none items-center gap-3 rounded-sm mx-2 my-1.5 text-sm outline-none transition-colors focus:bg-muted focus:rounded found:rounded-sm focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
    menuCheckboxItem:
