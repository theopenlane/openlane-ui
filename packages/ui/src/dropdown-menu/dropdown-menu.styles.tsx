...
export const dropdownMenuStyles = tv({
  slots: {
    ...
    icon: 'h-4 w-4"',
    separator: '-mx-8 my-1 h-px bg-oxford-blue-800 dark:bg-peat-800',
    subContent:
