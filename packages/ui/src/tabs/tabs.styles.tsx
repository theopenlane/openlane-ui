...
const tabsStyles = tv({
  slots: {
    tabsList: 'flex',
    tabsTrigger: '',
    tabsContent: 'mt-2 ring-offset-background text-md focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
  },
  variants: {
    variant: {
      underline: {
        ...
        tabsTrigger: [
          ...
          'transition-all ring-offset-background focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50',
