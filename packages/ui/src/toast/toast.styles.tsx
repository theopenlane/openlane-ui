...
export const toastStyles = tv({
  ...
  variants: {
    variant: {
      default: {
        toast: 'border-toast-border [background:var(--color-toast-success)]',
        description: 'text-toast-success',
      },
      info: {
        toast: 'border-toast-border [background:var(--color-toast-info)]',
        description: 'text-toast-info',
      },
      info2: {
        toast: 'border-toast-border [background:var(--color-toast-info2)]',
        description: 'text-toast-info2',
      },
      warning: {
        toast: 'border-toast-border [background:var(--color-toast-warning)]',
      ...
      error: {
        toast: 'border-toast-border [background:var(--color-toast-error)]',
