...
export const tableStyles = tv({
  slots: {
    ...
    tableHead: 'h-10 px-4 text-left align-middle text-muted-foreground bg-table-header-bg [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
  ...
  variants: {
    variant: {
      default: {},
      data: {
        tableHead: 'px-6 py-4 text-base font-normal leading-6',
