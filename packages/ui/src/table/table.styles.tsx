...
export const tableStyles = tv({
  slots: {
    ...
    tableFooter:
      'p-1 font-medium [&>tr]:last:border-b-0 ',
    tableRow:
      'px-2 border-b text-sm border-table-border-muted transition-colors hover:bg-table-row-bg-hover',
    tableHead:
      'h-12 px-4 text-left text-table-header border-table-border align-middle font-medium [&:has([role=checkbox])]:pr-0',
    tableCell:
