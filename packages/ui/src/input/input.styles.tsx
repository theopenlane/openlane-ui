...
export const inputStyles = tv({
  slots: {
    input:
      'flex text-sm h-10 px-3 !py-0 w-full font-sans bg-input-background border border-neutral-300 dark:border-brand rounded-md autofill:bg-white autofill:font-sans transition-colors file:border-0 file:bg-transparent file:text-base file:font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring disabled:cursor-not-allowed disabled:opacity-50',
