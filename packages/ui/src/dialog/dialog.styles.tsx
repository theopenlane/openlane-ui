...
export const dialogStyles = tv({
  slots: {
    ...
    close:
      'absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none  disabled:pointer-events-none data-[state=open]:bg-oxford-blue-100 data-[state=open]:text-oxford-blue-500 dark:ring-offset-oxford-blue-950 -blue-300 dark:data-[state=open]:bg-oxford-blue-800 dark:data-[state=open]:text-oxford-blue-400',
    closeIcon: 'h-4 w-4',
