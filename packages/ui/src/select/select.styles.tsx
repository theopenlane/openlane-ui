...
export const selectStyles = tv({
  slots: {
    trigger:
      ' flex h-10 w-full items-center justify-between rounded-md px-3 py-2 border border-neutral-300 dark:border-brand bg-input-background text-sm ring-offset-white focus:outline-none  disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
