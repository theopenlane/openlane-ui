...
const textareaStyles = cn(
  'flex min-h-[80px] w-full rounded-md border border-neutral-300 dark:border-brand bg-input-background px-3 py-2 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none  disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
)
