...
import { useChat } from '@repo/ui/components/editor/use-chat.ts'
...
> = {
  cursorCommand: [
    {
      items: [aiChatItems.generateMdxSample, aiChatItems.generateMarkdownSample, aiChatItems.continueWrite, aiChatItems.summarize, aiChatItems.explain],
    },
  ],
  cursorSuggestion: [
    {
  ...
  selectionCommand: [
    {
      items: [aiChatItems.improveWriting, aiChatItems.emojify, aiChatItems.makeLonger, aiChatItems.makeShorter, aiChatItems.fixSpelling, aiChatItems.simplifyLanguage],
    },
  ],
  selectionSuggestion: [
    {
