  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default: 'size-full px-16 pt-0 pb-72 text-base sm:px-[max(64px,calc(50%-350px))]',
        demo: 'size-full px-16 pt-0 pb-72 text-base sm:px-[max(64px,calc(50%-350px))]',
        fullWidth: 'size-full px-16 pt-0 pb-72 text-base sm:px-24',
        none: '',
