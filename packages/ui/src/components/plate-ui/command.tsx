...
const commandVariants = cva('flex size-full flex-col rounded-md bg-popover text-popover-foreground focus-visible:outline-hidden', {
  defaultVariants: {
    variant: 'default',
  },
  variants: {
  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 shadow-lg">
        ...
        <DialogDescription className="sr-only">Search through commands and documentation using the command menu</DialogDescription>
