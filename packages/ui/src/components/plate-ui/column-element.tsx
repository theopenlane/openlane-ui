  ...
  withRef<typeof PlateElement>(({ children, className, ...props }, ref) => {
    ...
    return (
      <div className="group/column relative" style={{ width: width ?? '100%' }}>
        ...
        <PlateElement ref={useComposedRef(ref, previewRef)} className={cn(className, 'h-full px-2 pt-2 group-first/column:pl-0 group-last/column:pr-0')} {...props}>
...
const DropLine = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => {
