...
>(({ children, state, ...props }, componentRef) => {
  ...
  return (
    <div ref={clickOutsideRef}>
      <Toolbar
        ref={ref}
        className={cn('absolute z-50 scrollbar-hide overflow-x-auto rounded-md border bg-popover p-1 whitespace-nowrap opacity-100 shadow-md print:hidden', 'max-w-[80vw]')}
        {...rootProps}
        {...props}
      >
        {children}
