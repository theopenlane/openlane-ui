...
export function CommentCreateForm({
  ...
  const commentContent = useMemo(() => (commentValue ? NodeApi.string({ children: commentValue as any, type: 'p' }) : ''), [commentValue])
      ...
      <div className="relative flex grow gap-2">
        ...
        >
          <EditorContainer variant="comment">
            <Editor variant="comment" className="min-h-[25px] grow pt-0.5 pr-8" placeholder="Reply..." autoComplete="off" autoFocus={autoFocus} />
