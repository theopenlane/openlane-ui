...
import { type PlateRenderElementProps, type RenderNodeWrapper, MemoizedChildren, ParagraphPlugin, useEditorRef, useElement, usePath, usePluginOption } from '@udecode/plate/react'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isNodeType([ImagePlugin.key, MediaEmbedPlugin.key, ExcalidrawPlugin.key, TogglePlugin.key, ColumnPlugin.key]) && 'py-0',
