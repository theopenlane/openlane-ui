...
export const RedoToolbarButton = withRef<typeof ToolbarButton>((props, ref) => {
  ...
  return (
    <ToolbarButton ref={ref} disabled={disabled} onClick={() => editor.redo()} onMouseDown={(e) => e.preventDefault()} tooltip="Redo" {...props}>
      <Redo2Icon />
    </ToolbarButton>
  )
})
...
export const UndoToolbarButton = withRef<typeof ToolbarButton>((props, ref) => {
  ...
  return (
    <ToolbarButton ref={ref} disabled={disabled} onClick={() => editor.undo()} onMouseDown={(e) => e.preventDefault()} tooltip="Undo" {...props}>
      <Undo2Icon />
    </ToolbarButton>
  )
})
