  ...
  return (
    <>
      ...
      <span className="relative min-h-[1lh]">
        ...
        <Combobox ref={ref} className={cn('absolute top-0 left-0 size-full bg-transparent outline-none', className)} value={value} autoSelect {...inputProps} {...props} />
      </span>
    </>
  )
})
...
const InlineComboboxGroup = withCn(ComboboxGroup, 'hidden py-1.5 not-last:border-b [&:has([role=option])]:block')

const InlineComboboxGroupLabel = withCn(ComboboxGroupLabel, 'mt-1.5 mb-2 px-3 text-xs font-medium text-muted-foreground')
