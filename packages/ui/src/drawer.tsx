    ...
    <>
      <Transition.Root show={mobileMenuOpen} as={Fragment}>
        ...
        >
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="2xl:hidden fixed inset-0 bg-teal200/70 dark:bg-teal900/80" />
          </Transition.Child>
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              <Dialog.Panel>
                <div className="!w-72 !h-full !top-16 !inset-y-0 !z-30 !flex !flex-col bg-white dark:bg-teal800 border-0 border-r border-teal200 dark:border-teal700">
                      ...
                      <ul className="flex flex-1 flex-col space-y-1 overflow-y-scroll overflow-x-clip">
                        {routes.map((item: any, idx: number) =>
                          item.name !== '_divider' ? (
                            <li key={idx}>
                              {!item.children ? (
                                <Link
                                  ...
                                  className={clsx(
                                    item.current
                                      ? 'bg-teal50 dark:bg-teal700'
                                      : 'hover:bg-teal100 hover:dark:bg-teal900 hover:dark:text-oxford-blue-100',
                            ...
                            <li key={`${idx}_divider`}>
                              <div className="!h-0 !border-t !w-72 !border-teal200 dark:!border-teal700 -!ml-6 !my-6" />
                            </li>
                          ),
                        )}
                      </ul>
      ...
      <div
        className={clsx(
          ...
          'hidden z-50 lg:flex fixed top-16 h-[calc(100%-4rem)] flex-col bg-white dark:bg-teal800 border-0 border-r border-teal200 dark:border-teal700 transition-all ease-in-out',
        )}
      >
        <div className="flex grow flex-col gap-y-5 overflow-y-auto">
          <nav
      ...
      <button
        className={clsx(
          ...
          `left-0 lg:left-16 2xl:hidden flex !items-center !px-4 !py-3 !min-w-14 !fixed !bottom-0 !rounded-tr bg-white dark:bg-teal400 !border-t !border-r border-teal800 dark:border-teal100 !z-50`,
        )}
        onClick={() => {
