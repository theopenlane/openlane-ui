...
const NAMED_GRANT_RELATIONS = new Set(['audit_log_viewer', 'full_access'])

const isAccessEnumRelation = (relation) => relation.startsWith('can_') || NAMED_GRANT_RELATIONS.has(relation)
