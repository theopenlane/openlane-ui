...
export const GET_STANDARDS_PAGINATED = gql`
  query GetStandardsPaginated($where: StandardWhereInput, $first: Int, $after: Cursor, $last: Int, $before: Cursor, $orderBy: [StandardOrder!]) {
    standards(where: $where, first: $first, after: $after, last: $last, before: $before, orderBy: $orderBy) {
      edges {
        node {
          id
          shortName
