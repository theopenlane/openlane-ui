...
/* eslint-disable */
import type * as Types from './historyschema-types'

export * from './historyschema-types'
export type GetInternalPolicyHistoriesQueryVariables = Exact<{
  where?: Types.InternalPolicyHistoryWhereInput | null | undefined
  orderBy?: Types.InternalPolicyHistoryOrder | null | undefined
  first?: number | null | undefined
  after?: any
}>

export interface GetInternalPolicyHistoriesQuery {
  internalPolicyHistories: {
    ...
    edges: Array<{
      node: {
        ...
        ref: string | null
        historyTime: any
        operation: Types.InternalPolicyHistoryOpType
        ...
        name: string
        status: Types.InternalPolicyHistoryDocumentStatus | null
        summary: string | null
        details: string | null
        ...
        reviewDue: any
        reviewFrequency: Types.InternalPolicyHistoryFrequency | null
...
export interface UpdateBulkJobTemplateMutation {
  updateBulkJobTemplate: { updatedIDs: Array<string> | null }
}
