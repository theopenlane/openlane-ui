...
const defaultComponents = memoizeMarkdownComponents({
  ...
  table: ({ className, ...props }) => <table className={cn('aui-md-table my-5 w-full border-separate border-spacing-0 overflow-y-auto', className)} {...props} />,
  th: ({ className, ...props }) => (
  ...
  td: ({ className, ...props }) => <td className={cn('aui-md-td border-b border-l px-4 py-2 text-left last:border-r [[align=center]]:text-center [[align=right]]:text-right', className)} {...props} />,
  tr: ({ className, ...props }) => (
  ...
  pre: ({ className, ...props }) => <pre className={cn('aui-md-pre overflow-x-auto rounded-t-none! rounded-b-lg bg-black p-4 text-white', className)} {...props} />,
  code: function Code({ className, ...props }) {
    const isCodeBlock = useIsMarkdownCodeBlock()
    return <code className={cn(!isCodeBlock && 'aui-md-inline-code rounded border bg-muted font-semibold', className)} {...props} />
  },
  CodeHeader,
})
