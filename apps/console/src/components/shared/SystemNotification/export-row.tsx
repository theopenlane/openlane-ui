...
import { Bell, CheckCircle2, XCircle, Loader2, AlertTriangle, Download } from 'lucide-react'
import { TJob } from '@/components/shared/export/use-tracked-export.ts'
...
export function ExportRow({ job }: { job: TJob }) {
