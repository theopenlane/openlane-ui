import { Notification, NotificationObjectType } from '@/hooks/useSSENotifications'
...
const getNotificationIconData = (objectType: NotificationObjectType) => {
  switch (objectType) {
    case 'Program':
...
const NotificationIcon = ({ objectType }: { objectType: NotificationObjectType }) => {
