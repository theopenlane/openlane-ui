...
export function NotificationRow({ notification, onRead }: NotificationRowProps) {
  ...
  return (
    <div {...activatable(handleClick)} className={cn('flex items-center gap-3 py-2 cursor-pointer transition-colors hover:bg-accent/50 px-1 rounded-md', isUnread && 'bg-accent/20')}>
