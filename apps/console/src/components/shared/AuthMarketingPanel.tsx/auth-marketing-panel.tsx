  ...
  return (
    <div className="hidden lg:flex flex-col justify-center rounded-lg w-2/5 w-[560px] relative overflow-hidden">
      <div className="flex flex-col space-y-10 z-10 pl-[64px] pr-[64px]">
        <span>“Openlane makes compliance effortless. What used to take us weeks of manual work now happens automatically—and the dashboards give our team total visibility.”</span>
        <div className="flex items-center gap-4 mt-2">
          <div className="w-12 h-12 rounded-full overflow-hidden border border-muted">
            <Image src="/" alt="Emily Carter" width={48} height={48} className="object-cover" />
          </div>

          <div className="flex flex-col">
            <span className="font-medium text-sm text-foreground">Emily Carter</span>
            <span className="text-sm text-muted-foreground font-normal">Head of Security, Arctura Labs</span>
          </div>
        </div>
      </div>
