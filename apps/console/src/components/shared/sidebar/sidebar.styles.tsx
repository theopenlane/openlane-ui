...
const sidebarStyles = tv({
  slots: {
    ...
    sideNav:
      'text-black bg-white dark:text-neutral-50 bg-glaucous-900 text-sm left-8 opacity-0 transition-all duration-300 group-hover:z-50 group-hover:ml-4 group-hover:rounded group-hover:bg-foreground group-hover:p-2 group-hover:opacity-100',
  },
  variants: {
    status: {
      true: {
