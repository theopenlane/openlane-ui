...
const sidebarNavStyles = tv({
  slots: {
    ...
    accordionTrigger: 'group relative flex h-[2.2rem] justify-between px-4 py-2 duration-200 hover:bg-muted hover:rounded-sm hover:no-underline',
    link: 'font-sans px-4 py-1 group relative flex h-[2.2rem] justify-start items-center hover:bg-muted hover:rounded-sm hover:no-underline',
