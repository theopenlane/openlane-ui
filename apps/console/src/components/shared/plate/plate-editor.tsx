...
import { ThemeAwareFontBackgroundColorPlugin, ThemeAwareFontColorPlugin } from '@theopenlane/ui/components/editor/plugins/font-kit.tsx'
import { type Value, type TElement, KEYS } from 'platejs'
import { EditorKitVariant, type TPlateEditorVariants } from '@theopenlane/ui/components/editor/use-create-editor.ts'
import { Editor, EditorContainer, type TPlateEditorStyleVariant } from '@theopenlane/ui/components/ui/editor.tsx'
import { createPlateEditor, Plate, type PlatePlugin, usePlateEditor } from 'platejs/react'
import { detectFormat } from './usePlateEditor'
import { type CommentEntityType, discussionPlugin } from '@theopenlane/ui/components/editor/plugins/discussion-kit.tsx'
import { pdfExportPlugin } from '@theopenlane/ui/components/editor/plugins/pdf-export-kit.tsx'
import { stripDraftCommentMarks } from '@theopenlane/ui/components/editor/comment-utils.ts'
