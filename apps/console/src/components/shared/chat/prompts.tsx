...
export const examplePrompts = [
    {
        text:
            <>
                <div className="flex">
                    <KeyIcon className="pr-2" />What is a control objective?
                </div>
            </>
        ,
    ...
    },
    {
        text:
            <>
                <div className="flex">
                    <ShieldPlusIcon className="pr-2" />What are the pillars of SOC2?
                </div>
            </>
        ,
    ...
    },
    {
        text:
            <>
                <div className="flex">
                    <CircleHelpIcon className="pr-2" />Does ISO 27001 cover GDPR?
                </div>
            </>
        ,
