...
const avatarUploadStyles = tv({
  slots: {
    wrapper: 'relative rounded-sm border-dashed border border-teal-800/40 dark:border-teal-100/40 py-5 px-[110px] text-center h-[109px] flex items-center justify-center transition ease-in',
