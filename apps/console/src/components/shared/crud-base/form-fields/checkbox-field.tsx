...
export const CheckboxField: React.FC<CheckboxFieldProps> = ({ name, label, isEditing, isEditAllowed, isCreate = false, data, internalEditing, setInternalEditing, className }) => {
