...
export const PersonnelStatusIconMapper: Record<IdentityHolderUserStatus, React.ReactNode> = {
  ...
  [IdentityHolderUserStatus.UNKNOWN]: <CircleHelp height={16} width={16} className="text-muted-foreground" />,
}
...
const PersonnelStatusColorMapper: Record<IdentityHolderUserStatus, string> = {
  ...
  [IdentityHolderUserStatus.UNKNOWN]: 'text-muted-foreground bg-muted border-border',
}
