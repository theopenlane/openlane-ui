...
// adapted from https://lucide-animated.com/r/key-circle.json
...
const KeyCircleIconBase = ({ ref, className, size, ...props }: KeyIconProps) => {
...
export const KeyCircleIcon = Object.assign(KeyCircleIconBase, { animated: true as const })
