...
// adapted from https://lucide-animated.com/r/lock.json
...
interface LockIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number
  ref?: Ref<LockIconHandle>
}

const LockIconBase = ({ ref, className, size, ...props }: LockIconProps) => {
...
export const LockIcon = Object.assign(LockIconBase, { animated: true as const })
