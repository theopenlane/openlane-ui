...
// adapted from https://lucide-animated.com/r/laptop-minimal-check.json
...
interface LaptopMinimalCheckIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number
  ref?: Ref<LaptopMinimalCheckIconHandle>
}
...
const LaptopMinimalCheckIconBase = ({ ref, className, size, ...props }: LaptopMinimalCheckIconProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.path animate={controls} d="m9 10 2 2 4-4" initial="normal" style={{ transformOrigin: 'center' }} variants={CHECK_VARIANTS} />
      </svg>
    </div>
  )
}
...
export const LaptopMinimalCheckIcon = Object.assign(LaptopMinimalCheckIconBase, { animated: true as const })
