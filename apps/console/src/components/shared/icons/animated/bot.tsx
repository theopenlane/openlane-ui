...
// adapted from https://lucide-animated.com/r/bot.json
...
interface BotIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number
  ref?: Ref<BotIconHandle>
}

const BotIconBase = ({ ref, className, size, ...props }: BotIconProps) => {
...
export const BotIcon = Object.assign(BotIconBase, { animated: true as const })
