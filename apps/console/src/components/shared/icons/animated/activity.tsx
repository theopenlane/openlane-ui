...
// adapted from https://lucide-animated.com/r/activity.json
...
const ActivityIconBase = ({ ref, className, size, ...props }: ActivityIconProps) => {
...
export const ActivityIcon = Object.assign(ActivityIconBase, { animated: true as const })
