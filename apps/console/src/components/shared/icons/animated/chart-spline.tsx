...
// adapted from https://lucide-animated.com/r/chart-spline.json
...
const ChartSplineIconBase = ({ ref, className, size, ...props }: ChartSplineIconProps) => {
...
export const ChartSplineIcon = Object.assign(ChartSplineIconBase, { animated: true as const })
