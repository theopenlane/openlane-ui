...
// adapted from https://lucide-animated.com/r/bookmark.json
...
const BookmarkIconBase = ({ ref, className, size, ...props }: BookmarkIconProps) => {
...
export const BookmarkIcon = Object.assign(BookmarkIconBase, { animated: true as const })
