...
// adapted from https://lucide-animated.com/r/mail-check.json
...
const MailCheckIconBase = ({ ref, className, size, ...props }: MailCheckIconProps) => {
...
export const MailCheckIcon = Object.assign(MailCheckIconBase, { animated: true as const })
