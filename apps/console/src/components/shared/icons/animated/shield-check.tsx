...
// adapted from https://lucide-animated.com/r/shield-check.json — the check mark redraws on hover
...
const ShieldCheckIconBase = ({ ref, className, size, ...props }: ShieldCheckIconProps) => {
...
export const ShieldCheckIcon = Object.assign(ShieldCheckIconBase, { animated: true as const })
