...
// adapted from https://lucide-animated.com/r/users.json
...
const UsersIconBase = ({ ref, className, size, ...props }: UsersIconProps) => {
...
export const UsersIcon = Object.assign(UsersIconBase, { animated: true as const })
