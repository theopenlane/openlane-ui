...
const organizationSelectorStyles = tv({
  slots: {
    ...
    organizationLabel:
      'text-aquamarine-900 uppercase font-mono text-sm font-semibold tracking-wide',
    organizationDropdown: 'flex items-center gap-[6px] text-lg cursor-pointer',
    dropdownContent: 'p-0',
    allOrganizationsLink:
      'flex items-center gap-2 text-aquamarine-900 py-5 px-6 border-t border-oxford-blue-200',
    ...
    orgTitle: 'text-sm text-oxford-blue-800',
    orgSelect:
