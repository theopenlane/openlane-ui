...
import { BulkEditDialog } from '../bulk-edit/bulk-edit'
import { BulkCSVCreateDialog } from '../create/dialog/bulk-csv-create-dialog'
      ...
      <div className="flex items-center gap-2 my-2">
        ...
        <div className="grow flex flex-row items-center gap-2 justify-end">
          {props.selectedAssets.length > 0 ? (
            <>
              {props.canEdit(props.permission?.roles) && <BulkEditDialog selectedAssets={props.selectedAssets} setSelectedAssets={props.setSelectedAssets}></BulkEditDialog>}
              <Button
                type="button"
                variant="secondary"
                onClick={() => {
