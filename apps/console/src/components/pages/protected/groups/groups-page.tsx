...
const GroupsPage = () => {
  ...
  const { setReexecuteGroupsQuery } = useGroupsStore()
  ...
  const [queryResult, reexecuteQuery] = useGetAllGroupsQuery({
    variables: { where: whereFilter },
    requestPolicy: 'network-only',
  })

  useEffect(() => {
    setReexecuteGroupsQuery(() => reexecuteQuery())
  }, [reexecuteQuery, setReexecuteGroupsQuery])
  ...
  return (
    <>
      ...
      {activeTab === 'table' ? <GroupsTable queryResult={queryResult} /> : <GroupsCard queryResult={queryResult} />}
      <GroupDetailsSheet />
    </>
  )
}
