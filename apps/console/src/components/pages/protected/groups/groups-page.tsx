...
import { GroupOrderField, GroupSettingVisibility, UserRole } from '@repo/codegen/src/schema'
...
const GroupsPage = () => {
  ...
  const { data, isError, isPending } = useGetAllGroups(whereFilter)
  return (
    <>
      ...
      <div className="flex justify-between">
        <div className="flex items-center gap-5">
          ...
          <Input
            ...
            name="groupSearch"
            placeholder="Search..."
            className="!bg border !border-border h-[34px]"
