...
const AuditorDashboardPage: React.FC = () => {
  ...
  }, [programIdParam, programOptions])

  useEffect(() => {
    if (selectedProgramId && selectedProgramId !== programIdParam) {
      replace({ [PROGRAM_PARAM]: selectedProgramId })
    }
  }, [selectedProgramId, programIdParam, replace])
  ...
  return (
    <div className="flex flex-col gap-6">
      <AuditorDashboardHeader
        ...
        onSelectProgram={(programId) => replace({ [PROGRAM_PARAM]: programId })}
      />
