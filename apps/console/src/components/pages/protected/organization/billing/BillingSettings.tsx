...
import { Switch } from '@repo/ui/switch' // Assuming you have a Switch component
import BillingContactDialog from './BillingContactDialog'
        ...
        <div className="flex gap-10 w-full ">
          ...
          <div className="flex justify-between w-full gap-4">
            <div>
              ...
              <p className="mt-2 text-text-paragraph font-medium">Josh Gibbons</p>
