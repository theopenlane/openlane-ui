...
const BulkCSVCreateTaskDialog: React.FC<BulkCsvCreateTaskDialogProps> = ({ trigger, open: openProp, onOpenChange }) => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      await createBulkTask({ input: uploadedFile.file ?? undefined })
      successNotification({
        title: 'Tasks Created',
