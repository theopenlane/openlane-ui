...
type NameFieldProps = {
  ...
  initialValue?: string
  internalEditing: keyof EditVendorFormData | null
  setInternalEditing: (field: keyof EditVendorFormData | null) => void
}
...
const NameField: React.FC<NameFieldProps> = ({ isEditing, isEditAllowed = true, handleUpdate, initialValue, internalEditing, setInternalEditing }) => {
  const { control, getValues, setValue, formState } = useFormContext<EditVendorFormData>()
