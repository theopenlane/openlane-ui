...
const formSchema = z.object({
  ...
  score: z.coerce.number<number>().min(0).max(100).optional(),
  impact: z.enum(RiskRiskImpact).optional(),
  likelihood: z.enum(RiskRiskLikelihood).optional(),
  status: z.enum(RiskRiskStatus).optional(),
