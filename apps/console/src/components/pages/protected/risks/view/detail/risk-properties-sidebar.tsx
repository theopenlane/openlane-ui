    ...
    <>
      <Card className="p-4 bg-card rounded-xl shadow-xs">
        ...
        <div className="flex flex-col gap-3">
          <ResponsibilityField name="stakeholder" fieldBaseName="stakeholder" label="Stakeholder" icon={<UserRound className={iconClass} />} {...sharedFieldProps} allowRawInput={false} />

          <ResponsibilityField name="delegate" fieldBaseName="delegate" label="Delegate" icon={<UserRoundCheck className={iconClass} />} allowRawInput={false} {...sharedFieldProps} />
        </div>
      </Card>
      <Card className="p-4 bg-card rounded-xl shadow-xs">
