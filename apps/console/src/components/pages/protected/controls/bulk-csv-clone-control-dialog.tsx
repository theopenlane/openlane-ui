...
const BulkCSVCloneControlDialog: React.FC<BulkCsvCreateControlDialogProps> = ({ trigger, open: openProp, onOpenChange }) => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      await cloneBulkControl({ input: uploadedFile.file ?? new File([], '') })
      successNotification({
