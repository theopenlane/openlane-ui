...
import { useCreateBulkCSVMappedControl } from '@/lib/graphql-hooks/controls.ts'
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <Card className="mt-6 p-4 flex gap-3">
          ...
          <p className="text-sm">
            ...
            <a href={`${DOCS_URL}${GRAPHQL_OBJECT_DOCS}#mappedcontrol`} target="_blank" className="text-brand hover:underline" rel="noreferrer">
              documentation
            </a>{' '}
