...
const BulkCSVCreateMappedControlDialog: React.FC<BulkCsvCreateMappedControlDialogProps> = ({ trigger, open: openProp, onOpenChange }) => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      await createBulkMappedControl({ input: uploadedFile.file ?? new File([], '') })
      successNotification({
