...
const programTypes: ProgramType[] = [
  {
    ...
    value: ProgramProgramType.FRAMEWORK,
  },
  {
    id: 'risk-assessment',
    ...
    value: ProgramProgramType.RISK_ASSESSMENT,
  },
  {
    id: 'gap-analysis',
    label: 'Gap Analysis',
    ...
    value: ProgramProgramType.GAP_ANALYSIS,
  },
  {
    id: 'other',
    label: 'Other',
    ...
    value: ProgramProgramType.OTHER,
  },
]
          ...
          {programTypes.map((item) => {
            ...
            return (
              <Card
                ...
                onClick={() => setValue('programType', item.value, { shouldValidate: true })}
              >
