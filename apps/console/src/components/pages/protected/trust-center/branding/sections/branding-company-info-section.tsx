...
export const BrandingCompanyInfoSection = ({ isReadOnly, setting }: BrandingCompanyInfoSectionProps) => {
  const {
    register,
    formState: { errors },
      ...
      <CardContent>
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <RenderBrandField name="companyName" label="Overview" component="input" isReadOnly={isReadOnly} setting={setting} register={register} />
            <p className="text-base font-medium">Description</p>
            <RenderBrandField name="companyDescription" label="Overview" component="input" isReadOnly={isReadOnly} setting={setting} register={register} />
          </div>
          <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-1">
            ...
            <RenderBrandField name="securityContact" label="Security Email" component="input" isReadOnly={isReadOnly} setting={setting} register={register} />
