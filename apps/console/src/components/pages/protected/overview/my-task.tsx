        ...
        <CardContent>
          ...
          <div className="space-y-3">
            {displayedTasks.map((task) => {
              ...
              return (
                <Link key={task.id} href={`/automation/tasks?id=${task.id}`} className="grid grid-cols-[120px_1fr] items-center gap-[20px] size-fit">
                  {' '}
          ...
          <Button variant="secondary" icon={<ChevronRight size={16} />} onClick={handleClick} className="mt-4">
            <Link href="/automation/tasks?showMyTasks=true">Show more Tasks</Link>
          </Button>
        </CardContent>
      </Card>
    </TooltipProvider>
