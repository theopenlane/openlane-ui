...
//       <PanelHeader heading="Let's Review!" subheading="Confirm you've filled out all the necessary information" noBorder />
...
//   const { reviewCardContent, checkIcon, xIcon, tooltip, inlineReviewValue, reviewValue, warnIcon, checkIconReview } = wizardStyles()
...
//         <PanelHeader heading={getValues().name} subheading={getValues().description} noBorder />
//         <Grid className="mt-2">
//           <GridRow columns={2} className="mx-2">
//             <GridCell>
//               <Card className="px-5 py-5">
//                 <div className={reviewCardContent()}>
//                   {getValues().framework ? <CheckIcon className={checkIcon()} size={20} /> : <XIcon className={xIcon()} size={20} />} Framework Chosen
//                   <TooltipProvider>
//                     <Tooltip>
//                       <TooltipTrigger>
...
//                     </Tooltip>
//                   </TooltipProvider>
//                   {getValues().framework ? <span className={inlineReviewValue()}>({getValues().framework})</span> : ''}
//                 </div>
//               </Card>
//             </GridCell>
//             <GridCell>
//               <Card className="px-5 py-5">
//                 <div className={reviewCardContent()}>
//                   {getValues().name ? <CheckIcon className={checkIcon()} size={20} /> : <XIcon className={xIcon()} size={20} />} Name Chosen
//                   <TooltipProvider>
//                     <Tooltip>
//                       <TooltipTrigger>
//                         <InfoIcon size={14} className="mx-1" />
...
//                     </Tooltip>
//                   </TooltipProvider>
//                   {getValues().name ? <span className={inlineReviewValue()}>({getValues().name})</span> : ''}
//                 </div>
//               </Card>
//             </GridCell>
//           </GridRow>
...
//               <Card className="px-5 py-5">
//                 <div className={reviewCardContent()}>
//                   {getValues().startDate && getValues().endDate ? <CheckIcon className={checkIcon()} size={20} /> : <XIcon className={xIcon()} size={20} />} Audit Period Set
//                   <TooltipProvider>
//                     <Tooltip>
//                       <TooltipTrigger>
//                         <InfoIcon size={14} className="mx-1" />
...
//                     <span className={inlineReviewValue()}>
//                       ({format(new Date(getValues().startDate), 'd MMM yyyy')} - {format(new Date(getValues().endDate), 'd MMM yyyy')})
//                     </span>
//                   ) : (
//                     ''
//                   )}
...
//               <Card className="px-5 py-5">
//                 <div className={reviewCardContent()}>
//                   {getValues().auditPartnerName || getValues().auditPartnerEmail ? <CheckIcon className={checkIcon()} size={20} /> : <TriangleAlertIcon className={warnIcon()} size={20} />} Audit
//                   Partner Provided
//                   <TooltipProvider>
//                     <Tooltip>
//                       <TooltipTrigger>
...
//                     </Tooltip>
//                   </TooltipProvider>
//                   {getValues().auditPartnerName ? <span className={inlineReviewValue()}>({getValues().auditPartnerName})</span> : ''}
//                 </div>
//               </Card>
//             </GridCell>
//           </GridRow>
...
//                       Program Admins <CheckIcon className={checkIconReview()} size={20} />
//                     </span>
//                   ) : (
//                     ''
//                   )}
...
//                     <span className={reviewValue()}>
//                       Program Members <CheckIcon className={checkIconReview()} size={20} />
//                     </span>
//                   ) : (
//                     ''
//                   )}
...
//                     <span className={reviewValue()}>
//                       Editor Groups <CheckIcon className={checkIconReview()} size={20} />
//                     </span>
//                   ) : (
//                     ''
//                   )}
...
//                     <span className={reviewValue()}>
//                       Viewer Groups <CheckIcon className={checkIconReview()} size={20} />
//                     </span>
//                   ) : (
//                     ''
//                   )}
...
//                         <span className={reviewValue()}>
//                           Risks Included <CheckIcon className={checkIconReview()} size={20} />
//                         </span>
//                       ) : (
//                         ''
//                       )}
...
//                         <span className={reviewValue()}>
//                           Policies Included <CheckIcon className={checkIconReview()} size={20} />
//                         </span>
//                       ) : (
//                         ''
//                       )}
...
//                         <span className={reviewValue()}>
//                           Procedures Included <CheckIcon className={checkIconReview()} size={20} />
//                         </span>
//                       ) : (
//                         ''
//                       )}
