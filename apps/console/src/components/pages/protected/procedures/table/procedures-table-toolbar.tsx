...
import { PROCEDURE_FILTERABLE_FIELDS, PROCEDURE_SORTABLE_FIELDS } from '@/components/pages/protected/procedures/table/table-config.ts'
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      <div className="grow flex flex-row items-center gap-2">
        ...
        <TableSort sortFields={PROCEDURE_SORTABLE_FIELDS} onSortChange={onSortChange} />
        <Input
