...
const StandardChip = ({ referenceFramework }: TStandardChipProps) => {
  return (
    <div className="inline-flex gap-1 items-center rounded-full px-2.5 py-0.5 border border-border text-xs font-semibold ransition-colors focus:outline-hidden h-fit shrink-0">
