...
import { type VulnerabilityQuery, type UpdateVulnerabilityInput } from '@repo/codegen/src/schema'
...
type PropertiesProps = {
  isEditing: boolean
  data: VulnerabilityQuery['vulnerability'] | undefined
  internalEditing: string | null
  setInternalEditing: (field: string | null) => void
  handleUpdateField?: (val: UpdateVulnerabilityInput) => void
...
const Properties: React.FC<PropertiesProps> = ({ isEditing, data, internalEditing, setInternalEditing, handleUpdateField, isEditAllowed }) => {
  const { control, formState, watch, setValue } = useFormContext<VulnerabilityFormData>()
