...
const DescriptionField: React.FC<DescriptionFieldProps> = ({ isEditing, isCreate, initialValue, isFormInitialized }) => {
  const { control, formState } = useFormContext<VulnerabilityFormData>()
      ...
      render={({ field }) => (
        <FormItem className="w-full py-4">
          <div className="flex items-center">
            ...
            <SystemTooltip icon={<InfoIcon size={14} className="mx-1 mt-1" />} content={<p>Provide a detailed description of the vulnerability</p>} />
          </div>
          <FormControl>
            <PlateEditor
              onChange={(val) => {
              ...
              placeholder="Write your vulnerability description"
            />
          </FormControl>
