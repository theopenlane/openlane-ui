...
export const AssetsStep = ({ domains, selected, setSelected, existingIds, overrides, setOverrides }: AssetsStepProps) => {
  const sections = (
    [
      { key: 'owned', title: 'Owned domains', description: 'Names are editable', items: domains.owned },
      { key: 'technologies', title: 'Technologies', description: 'Non-vendor technologies detected during the scan', items: domains.technologies },
      { key: 'external', title: 'External domains', description: 'Optional related domains detected during the scan', items: domains.external, collapsible: true, defaultOpen: false },
      { key: 'ip', title: 'IP addresses', description: 'Resolved IP addresses detected during the scan', items: domains.ip, collapsible: true, defaultOpen: false },
    ] satisfies AssetSection[]
