...
import { PostureStatusIcon } from '@/components/shared/enum-mapper/scan-enum'
      ...
      <CardContent className="pt-6 space-y-4">
        ...
        {company.isSoc2 !== undefined && (
          <div className="flex items-center gap-1.5 text-sm">
            {company.isSoc2 ? (
              <>
                <PostureStatusIcon status="good" /> SOC 2 Compliant
              </>
            ) : (
              <>
                <PostureStatusIcon status="bad" /> Not SOC 2 Compliant
              </>
            )}
          </div>
        )}
