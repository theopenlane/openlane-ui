                ...
                <GridRow columns={4}>
                    <GridCell className='col-span-2'>
                        <Panel
                            ...
                            justify="start"
                            textAlign="center"
                            className="min-h-[100px] h-full p-6"
                        >
                            <PanelHeader heading="Active Programs"
                                noBorder
                            />
                            {
                    ...
                    <GridCell>
                        <Panel
                            ...
                            className="min-h-[100px] h-full  p-6"
                        >
                            <PanelHeader heading="Tasks Due Soon"
                                noBorder
                            />
                            {
                    ...
                    <GridCell>
                        <Panel
                            ...
                            justify="start"
                            textAlign="center"
                            className="min-h-[100px] h-full p-6 flex"
                        >
                            <PanelHeader heading="Create a new program"
                                subheading="Get ready for your next audit, create a new program or duplicate an existing one."
                                noBorder
                            />
                ...
                <GridRow columns={1}>
                    <GridCell>
                        <Panel
                            ...
                            <PanelHeader heading="Program Progress"
                                noBorder
                            />
