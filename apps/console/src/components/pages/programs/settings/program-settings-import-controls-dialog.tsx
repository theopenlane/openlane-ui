  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent onOpenAutoFocus={(e) => e.preventDefault()} className="max-w-[497px]">
        ...
        {selectedImportControlsFrom === ObjectEnum.STANDARD ? <ImportControlsDialogFramework setSelectedItems={setSelectedItems} selectedItems={selectedItems} /> : <ImportControlsDialogProgram />}
