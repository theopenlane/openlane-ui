...
const verificationStyles = tv({
  slots: {
    ...
    errorMessage: 'mt-14',
    success: 'mt-14 bg-oxford-blue-900 bg-opacity-20 p-5 rounded-md justify-center text-center',
    successMessage: 'text-center',
    successIcon: 'mt-1 justify-center items-center',
    loading: 'mt-14 p-5 rounded-md flex gap-3',
    resendMessage: 'text-xs mt-4 text-center',
