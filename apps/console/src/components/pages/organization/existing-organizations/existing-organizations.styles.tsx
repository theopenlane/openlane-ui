...
const existingOrganizationsStyles = tv({
  slots: {
    ...
    orgWrapper: 'transition-all duration-500 flex gap-3 items-center pb-4 cursor-pointer relative',
...
export type ExistingOrganizationsVariants = VariantProps<typeof existingOrganizationsStyles>
