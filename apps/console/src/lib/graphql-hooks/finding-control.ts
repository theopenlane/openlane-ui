...
import { FINDING_CONTROL, GET_ALL_FINDING_CONTROLS, CREATE_FINDING_CONTROL, CREATE_CSV_BULK_FINDING_CONTROL, DELETE_FINDING_CONTROL, UPDATE_FINDING_CONTROL } from '@repo/codegen/query/finding-control'
