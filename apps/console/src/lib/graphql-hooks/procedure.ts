...
import {
  type CreateProcedureMutation,
  type CreateProcedureMutationVariables,
  type UpdateProcedureMutation,
  type UpdateProcedureMutationVariables,
  type GetAllProceduresWithDetailsQuery,
  type GetProcedureDetailsByIdQuery,
  type GetProcedureDetailsByIdQueryVariables,
  type DeleteProcedureMutation,
  type DeleteProcedureMutationVariables,
  type Procedure,
  type CreateBulkCsvProcedureMutation,
  type CreateBulkCsvProcedureMutationVariables,
  type GetProceduresListQueryVariables,
  type GetProceduresTableListQuery,
  type UpdateBulkProcedureMutation,
  type UpdateBulkProcedureMutationVariables,
  type CreateUploadProcedureMutation,
  type CreateUploadProcedureMutationVariables,
  type DeleteBulkProcedureMutation,
  type DeleteBulkProcedureMutationVariables,
  type GetProcedureAssociationsByIdQuery,
  type GetProcedureAssociationsByIdQueryVariables,
  type InsertProcedureCommentMutation,
  type InsertProcedureCommentMutationVariables,
  type GetProcedureDiscussionByIdQuery,
