...
import { DIRECTORY_MEMBERSHIP, GET_ALL_DIRECTORY_MEMBERSHIPS, CREATE_DIRECTORY_MEMBERSHIP, DELETE_DIRECTORY_MEMBERSHIP, UPDATE_DIRECTORY_MEMBERSHIP } from '@repo/codegen/query/directory-membership'
