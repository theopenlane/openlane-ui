...
import {
  ...
  type GetAllProgramsQueryVariables,
  type GetProgramDetailsByIdQuery,
  type GetProgramDetailsByIdQueryVariables,
  type CreateProgramWithMembersMutation,
  type CreateProgramWithMembersMutationVariables,
  type UpdateProgramMutation,
  type UpdateProgramMutationVariables,
  ...
  type GetProgramMembersQuery,
  type GetProgramMembersQueryVariables,
  type GetProgramGroupsQuery,
  type GetProgramGroupsQueryVariables,
  type DeleteProgramMutationVariables,
  type UpdateProgramMembershipMutationVariables,
