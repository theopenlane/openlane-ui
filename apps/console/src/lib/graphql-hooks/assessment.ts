...
import { CREATE_ASSESSMENT, UPDATE_ASSESSMENT, GET_ALL_ASSESSMENTS, GET_ASSESSMENT, DELETE_ASSESSMENT, DELETE_BULK_ASSESSMENT } from '@repo/codegen/query/assessment'
