...
import { VendorRiskScoresWithFilterQuery, VendorRiskScoresWithFilterQueryVariables, CreateVendorRiskScoreMutation, CreateVendorRiskScoreMutationVariables, UpdateVendorRiskScoreMutation, UpdateVendorRiskScoreMutationVariables, DeleteVendorRiskScoreMutation, DeleteVendorRiskScoreMutationVariables, VendorRiskScoreQuery, VendorRiskScoreQueryVariables, CreateBulkCsvVendorRiskScoreMutation, CreateBulkCsvVendorRiskScoreMutationVariables, UpdateBulkVendorRiskScoreMutation, UpdateBulkVendorRiskScoreMutationVariables, DeleteBulkVendorRiskScoreMutation, DeleteBulkVendorRiskScoreMutationVariables } from '@repo/codegen/src/schema'
import { fetchGraphQLWithUpload } from '@/lib/fetchGraphql'
import { TPagination } from '@repo/ui/pagination-types'
import { GET_ALL_VENDOR_RISK_SCORES, CREATE_VENDOR_RISK_SCORE, UPDATE_VENDOR_RISK_SCORE, DELETE_VENDOR_RISK_SCORE, VENDOR_RISK_SCORE, CREATE_CSV_BULK_VENDOR_RISK_SCORE, BULK_EDIT_VENDOR_RISK_SCORE, BULK_DELETE_VENDOR_RISK_SCORE } from '@repo/codegen/query/vendor-risk-score'
...
export const useVendorRiskScoresWithFilter = ({ where, orderBy, pagination, enabled = true }: GetAllVendorRiskScoresArgs) => {
  ...
  const vendorRiskScoresNodes: VendorRiskScoresNodeNonNull[] = edges.filter((edge) => edge != null).map((edge) => edge?.node as VendorRiskScoresNodeNonNull)
